...
CREATE TABLE Clients (
    ...
    Address CLOB,
    -- Adding this constraint to make sure we can add relationship only if the client is a guest
    -- Table-level constraint for Client_Category and Relationship
...
CREATE TABLE Fitness_Classes (
    ...
    Class_Type VARCHAR2(10) CHECK (Type IN ('Yoga', 'Pilates', 'HIIT', 'Spinning')) NOT NULL,
...
CREATE TABLE Discounts (
    ...
    Discount_Type VARCHAR2(15) CHECK (Type IN ('Promotion', 'Referral')) NOT NULL,
...
CREATE TABLE Staff (
    ...
    First_Name VARCHAR2(100) NOT NULL,
    Last_Name VARCHAR2(100) NOT NULL,
    Staff_Role VARCHAR2(15) CHECK (Role IN ('Trainer', 'Instructor', 'Support Staff', 'Admin')) NOT NULL,
