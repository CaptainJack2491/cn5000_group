...
CREATE TABLE Health_Assessments (
    Assessment_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    Client_ID NUMBER NOT NULL,
    Trainer_ID NUMBER NOT NULL,
...
CREATE TABLE Billing (
    Billing_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    Client_ID NUMBER NOT NULL,
    Amount NUMBER(10, 2) NOT NULL,
    B_Date DATE NOT NULL,
    Payment_Method VARCHAR2(15),
    Discount_Applied CHAR(1) DEFAULT 'N',
...
CREATE TABLE Facilities (
    Facility_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    Name VARCHAR2(100) NOT NULL,
...
CREATE TABLE Equipment_Rentals (
    Rental_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
