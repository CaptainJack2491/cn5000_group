...
--3
--LATEST Q3 QUERY VERSION -3
SELECT
    SUM(AMOUNT) AS TOTAL_REVENUE,
    SUM(CASE WHEN SERVICE_NAME = 'Membership' THEN AMOUNT ELSE 0 END) AS REVENUE_FROM_MEMBERSHIPS,
    SUM(CASE WHEN SERVICE_NAME = 'Class Booking' THEN AMOUNT ELSE 0 END) AS REVENUE_FROM_CLASS_BOOKINGS,
    SUM(CASE WHEN SERVICE_NAME = 'Personal Training' THEN AMOUNT ELSE 0 END) AS REVENUE_FROM_PERSONAL_TRAINING
FROM BILLING
...
SELECT 
(SELECT SUM(AMOUNT) FROM BILLING WHERE SERVICE_NAME = 'Membership') AS REVENUE_FROM_MEMBERSHIPS,
(SELECT SUM(AMOUNT) FROM BILLING WHERE SERVICE_NAME = 'Class Booking') AS REVENUE_FROM_CLASSING_BOOKINGS,
(SELECT SUM(AMOUNT) FROM BILLING WHERE SERVICE_NAME = 'Personal Training') AS REVENUE_FROM_PERSONAL_TRAINING
FROM BILLING
WHERE SERVICE_NAME IN ('Membership', 'Class Booking', 'Personal Training');

--OLD Q3 QUERY VERSION - 1
